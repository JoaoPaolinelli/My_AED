...
class Musicas {
    ...
    private float tempo;
    private Musicas[] sortMusic = new Musicas[101];

    Musicas() {};

    public Musicas[] getSortMusic() {
        return sortMusic;
    }

    public void setSortMusic(Musicas[] sortMusic) {
...
//        instrumentalness ## liveness ## loudness ## speechiness ## energy ## duration
    ...
    public static void idReconhecido(Musicas[] musicas, String[] entrada, int idEntrada) {
        Musicas[] music2 = new Musicas[55555];
...
//    public static void ordenarID(Musicas[] music){
//
//        for (int i = 0; i < music.length ; i++) {
//            int tmp = music[i].getId().charAt(0);
//            int j = music.length-1;
//            String tmp2 = music[j].getId();
//            while((( j >= 0)) && (musicS[j].getId().compareTo(musicS[i].getId()) >1) ){
//                 music[j+1] = music[j];
//                 j--;
//            }
//            music[j+1] = music[i];
...
//    }
    public static void main(String[] args) throws ParseException{
        ...
        idReconhecido(music,entrada, idEntrada); // Ordenar as musicas a partir do pub.in
    }
}

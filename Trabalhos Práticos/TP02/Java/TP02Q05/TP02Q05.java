...
class TP02Q05 {
    ...
    public TP02Q05(String id, List artistas, String name, String data,
...
//        instrumentalness ## liveness ## loudness ## speechiness ## energy ## duration
    ...
    public static void idReconhecido(TP02Q05[] musicas) {
        ...
        TP02Q05[] music2 = new TP02Q05[idEntrada];
    ...
    public static TP02Q05[] lerArq() throws ParseException {

        TP02Q05[] music = new TP02Q05[999999];
        int j=1;
    ...
    public static void ordenarNomes(TP02Q05[] music){
        ...
        for (int i = 0; i < music.length ; i++) {
            ...
            TP02Q05 temp = music[menor];
            music[menor] = music[i];
            music[i] = temp;
        }
        for(TP02Q05 musicas: music){
            musicas.imprimir();
        }
    }
    public static void main(String[] args) throws ParseException{

        TP02Q05[] music; // Vetor de musicas
        music = lerArq(); // Le csv e retorna um vetor com as musicas.

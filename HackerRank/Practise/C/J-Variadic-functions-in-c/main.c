...
int  sum (int count,...) {
    ...
    va_list teste;
    int soma = 0;
    va_start(teste, count);
    
    for(int i =0; i < count; i++)
        soma += va_arg(teste, int);
...
int max(int count,...) {
    ...
    va_list elementos;
    int maior = 0;
    va_start (elementos, count);
    int tmp = va_arg(elementos, int);
